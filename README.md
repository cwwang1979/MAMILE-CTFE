...
#### Download
For malignancy detection, the execution file, configuration file, and models are downloaded from the [zip]([https://drive.google.com/open?id=1I-j4xxBUAdbSy7hXjImfqv3UD_TNvAio&usp=drive_copy](https://drive.google.com/open?id=1CuQoWVIhxiIt5ryrlS7B0SejAGtxKz7i&usp=drive_copy)) file. Meanwhile, files for cancer origin identification can be obtained from the [zip]([https://drive.google.com/open?id=1VbuBmIywwwawldBSBn4jSPTQAmSXTyFu&usp=drive_copy](https://drive.google.com/open?id=1cZ9rXVKM5kWY0VDoNkQK__86p57X3uvs&usp=drive_copy)) file. (For reviewers, please use the password provided in the Code Availability section of the associated manuscript to decompress the file.)
